        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2 className="pricing14-text101 thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="pricing14-text201">Pricing plan</span>
                </Fragment>
              )}
            </h2>
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text193">N/A</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                      ...
                      {props.plan1Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text199">
                            Recycling ash for man-made islands
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text198">$50,000/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                      ...
                      {props.plan2Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text167">
                            Additional land reclamation services
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan2Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text190">
                            Customized island design options
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text164">$100,000/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                      ...
                      {props.plan3Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text184">
                            Exclusive access to premium island locations
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan3Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text196">
                            Priority scheduling and project management support
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  ...
                  <h3 className="pricing14-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text155">$200/yr</span>
                      </Fragment>
                    )}
                  </h3>
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3 className="pricing14-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text170">$299/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <h3 className="pricing14-text147 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text171">$499/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
